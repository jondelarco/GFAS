...
#
#			Parametros:
#						1 - ID del grupo a controlar. 
#						2 - Tiempo maximo en ms
#						3 - Numero maximo de mensajes
#						4-	Indica si es critico o no el flujo (opcional)
#						5 - Cod_dest de la aplicacion que se quiera monitorizar (opcional)
#-----------------------------------------------------------------------
