...
VDATABASE1="-MDQ $MDQ_FILE  -DBNAME GREDAPR  -STMT  SELECT  COD_LOC, COD_ART_FORMLOG, TIPO_PILADA, ANO_PILADA, COD_PILADA, CANT_IMPLANTACION_MIN_UDS, CANT_CAPACIDAD_MAX_UDS, FEC_INICIO, FEC_FIN, COD_ORIGEN, FLG_VENTA_NORMAL, FLG_PILADA_OFERTA, FLG_PILADA_CABECERA, FLG_PILADA_CAMPANA, FEC_GEN, FLG_ENVIADO_AC, MSGID, NUM_OFERTA, CREATED_BY, CREATION_DATE, LAST_UPDATED_BY, LAST_UPDATE_DATE, LAST_UPDATE_LOGIN, TECLE, TCN, DESC_PERIODO, ESPACIO_PROMO, SUSTITUIR, TIPO_MODIF, FECHA_HASTA_MODIF, PORCENTAJE_MODIF, CANT_MAX_CENTRO, FLG_VALIDADO FROM piladas_planogramadas WHERE msgid = ''${MSGID}''"
